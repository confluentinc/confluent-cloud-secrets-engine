...
ifeq ($(CI),true)
# no change to any prior testing stage, but repeating for completeness.
...
# after all previous testing stages are complete, scan and report.
test-pyramid-post-steps: sonar-scan
endif
endif
